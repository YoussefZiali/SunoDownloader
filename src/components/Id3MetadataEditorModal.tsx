...
export const Id3MetadataEditorModal: React.FC<Id3MetadataEditorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-2xl p-0 md:p-4 lg:p-6 text-white">
      <div 
        className="w-full h-full md:h-auto md:max-h-[90vh] max-w-md bg-[#0e0f14] md:border border-neutral-800 md:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="sticky top-0 z-30 flex items-center justify-between p-3.5 sm:p-5 border-b border-neutral-800/80 bg-neutral-900/95 backdrop-blur-xl shrink-0 pt-[max(0.75rem,env(safe-area-inset-top))]">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-sm sm:text-base font-bold text-white tracking-tight truncate">ID3 Metadata Studio</h2>
              <p className="text-xs text-neutral-400 truncate">Embed tags into downloaded MP3 & FLAC</p>
            </div>
          </div>
          <button
            onClick={onClose}
            aria-label="Close Metadata Studio"
        ...
        {/* Content */}
        <div className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1 custom-scrollbar pb-[max(2rem,env(safe-area-inset-bottom))]">
