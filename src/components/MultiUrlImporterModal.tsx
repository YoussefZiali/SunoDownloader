...
export const MultiUrlImporterModal: React.FC<MultiUrlImporterModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-2xl p-0 md:p-4 lg:p-6">
      <div 
        className="w-full h-full md:h-auto md:max-h-[90vh] max-w-2xl bg-[#0e0f13] md:border border-neutral-800 md:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200"
        id="multi-url-modal"
      >
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <h2 className="text-sm sm:text-base font-bold text-white tracking-tight truncate">Bulk URL Importer</h2>
